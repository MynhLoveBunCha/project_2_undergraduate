###########################################################################
## Makefile generated for component 'My_PID_Controller'. 
## 
## Makefile     : My_PID_Controller.mk
## Generated on : Tue Jan 16 11:48:39 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/My_PID_Controller.elf
...
PRODUCT_NAME              = My_PID_Controller
MAKEFILE                  = My_PID_Controller.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/doann/OneDrive/Desktop/2023_1/do_an_2/MATLAB/xml_files_main
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/doann/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ESP32W~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/My_PID_Controller.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=3 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=62411 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=3 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_CONFIG_SERIAL2_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=My_PID_Controller -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = My_PID_Controller.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
%.o : $(START_DIR)/My_PID_Controller_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/My_PID_Controller_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/My_PID_Controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/My_PID_Controller_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


My_PID_Controller.o : $(START_DIR)/My_PID_Controller_ert_rtw/My_PID_Controller.c
	$(CC) $(CFLAGS) -o "$@" "$<"
