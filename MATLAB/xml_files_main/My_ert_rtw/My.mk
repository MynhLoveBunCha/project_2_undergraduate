###########################################################################
## Makefile generated for component 'My'. 
## 
## Makefile     : My.mk
## Generated on : Tue Jan 16 11:23:29 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/My.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/My.elf
...
DEFINES_STANDARD = -DMODEL=My -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = My.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o
...
%.o : $(START_DIR)/My_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/My_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/My_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


My.o : $(START_DIR)/My_ert_rtw/My.c
	$(CC) $(CFLAGS) -o "$@" "$<"
